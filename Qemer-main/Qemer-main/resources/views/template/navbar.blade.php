<nav class="navbar navbar-dar navbar-expand-md bg-white absolute-top nav-colored mb-0" style="width: 100%" id="mynav">
    <div class="container-fluid ">
        <a class="navbar-brand text-white fs-2" href="#"><img class="" src="image/alen.png" alt="Alen-Logo"
                style=" width: 7%; height:7%;"></a>
        ...
        <div class="collapse navbar-collapse nav justify-content-end " id="navbarSupportedContent">
            <nav class="">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-pharma fs-4 px-2 btnhover rounded-3" href="/contact">Contact</a>
                    </li>
                    <li class="nav-item">
